...
function get_emoji(emojip, sname) {
    var Lmoji = {
        ...
        "💩": ["RU ", "RU-", "RU_", "RUS", "俄西斯", "Ruscism"],
        "🍌": ["SG", "Singapore", "SINGAPORE", "新加坡", "狮城", "獅城", "李家坡", "京新", "泉新", "穗新", "深新", "杭新", "广新,,🇺🇸": ["US", "USA", "America", "United States", "美国", "美", "京美", "波特兰", "达拉斯", "俄勒冈", "凤凰城", "费利蒙", "硅谷", "矽谷", "拉斯维加斯", "洛杉矶", "圣何塞", "圣荷西", "圣克拉拉", "西雅图", "芝加哥", "沪美", "哥伦布", "纽约"],
