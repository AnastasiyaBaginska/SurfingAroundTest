...
//为节点名添加 emoji
//穆畜政權，共慘政權，鵝雜碎的走狗政權均做處理
//尚未補齊全部國家
//期待格式：emoji：兩位縮寫/三位縮寫/我國譯名/淪陷區譯in殘體中文/英文名/英文全稱
function get_emoji(emojip, sname) {
    var Lmoji = {
        ...
        "🇱🇹": ["立陶宛", "Lithuania"],
        "🇱🇰": ["斯里兰卡", "斯里蘭卡", "Sri Lanka"],
        "⚪️🔴⚪️": ["BY", "白俄罗斯", "白俄羅斯", "White Russia", "Republic of Belarus", "Belarus"],
        "💩🏳️🖕": ["RU ", "RU-", "RU_", "RUS", "Russia", "俄罗斯", "毛子", "俄雜碎", "俄羅斯", "伯力", "莫斯科", "圣彼得堡", "西伯利亚", "新西伯利亚", "京俄", "杭俄", "廣俄", "滬俄", "广俄", "沪俄"],
        ...
        "🐖7️⃣": ["United Arab Emirates", "阿联酋", "AE ", "迪拜", "阿聯酋", "Dubai"],
        "🇧🇷": ["BR", "Brazil", "巴西", "圣保罗"],
        ...
        "💩🕷️": ["CN", "China", "回国", "中国", "中國", "江苏", "北京", "上海", "广州", "深圳", "杭州", "徐州", "青岛", "宁波", "镇江", "back"],
        "💩🚬": ["古巴"],
        "🇸🇲": ["圣马力诺", "聖馬利諾"],
        "🇰🇾": ["开曼群岛", "開曼群島"],
        "🇫🇯": ["斐济", "斐濟"],
